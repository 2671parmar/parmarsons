        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-4 opacity-0 animate-fade-in animate-delay-300">
              ...
              <p className="text-muted-foreground opacity-0 animate-fade-in animate-delay-400">
      ...
      <section className="py-16 bg-secondary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-card p-8 rounded-lg shadow-md opacity-0 animate-fade-in animate-delay-100">
            ...
            <div className="bg-card p-8 rounded-lg shadow-md opacity-0 animate-fade-in animate-delay-200">
              <div className="flex items-center mb-4">
            ...
            <div className="bg-card p-8 rounded-lg shadow-md opacity-0 animate-fade-in animate-delay-300">
              <div className="flex items-center mb-4">
            ...
            <div className="bg-card p-8 rounded-lg shadow-md opacity-0 animate-fade-in animate-delay-400">
              <div className="flex items-center mb-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              ...
              <div 
                key={tech.name}
                className={`bg-card p-4 rounded-lg border border-border shadow-sm opacity-0 animate-fade-in`}
